...
//go:generate swagger generate server --target ../../app --name Sendmail --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/sendmail/build/templates --principal interface{}

func configureFlags(api *operations.SendmailAPI) {
...
func configureAPI(api *operations.SendmailAPI) http.Handler {
